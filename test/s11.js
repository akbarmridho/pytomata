...
const vertical_product = (grid, n_number) => {
...
const horizontal_product = (grid, n_number) => {
	let biggest_product = 0;
	let product = 1;
...
const product_of_a_grid = (grid, n_number, direction) => {
	let biggest_product = 0;
	let product = 1;
	if (direction === "v"){
		var [start_i, start_j, vertical_subtractor, horizontal_subtractor, x, y] = [0, 0,n_number-1, 0, 0, 1];
	} else if (direction === "h"){
		var [start_i, start_j, vertical_subtractor, horizontal_subtractor, x, y] = [0, 0, 0, n_number-1, 1, 0];
	} else if (direction === "d_r") {
		var [start_i, start_j, vertical_subtractor, horizontal_subtractor, x, y] = [0, 0, n_number-1, n_number-1, 1, 1];
	} else if (direction === "d_l"){
		var [start_i, start_j, vertical_subtractor, horizontal_subtractor, x, y] = [n_number-1, n_number-1, 0, 0, -1, 1]
	}
...
const largest_product_of_grid = (grid, n_number) =>{
